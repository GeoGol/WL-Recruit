...
import {RiCloseLine, RiMenu3Line, RiSettings3Line} from "@remixicon/react";
            ...
            <div className = "p-3 flex items-center justify-between w-full h-full gap-6">
                ...
                <div className = "flex justify-end items-center gap-4 relative">
                    ...
                    <div className = "relative" ref = {settingsRef}>
                        ...
                        {openId === 'settings' && (
                            <div
                                className = "absolute right-0 top-10 w-48 bg-surface border border-gray-200 rounded-md shadow-lg z-50">
                                <ul className = {'p-2'}>
