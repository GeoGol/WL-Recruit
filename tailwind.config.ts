...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        // Primary — semantic keys + Flowbite-compatible numeric aliases
        primary: {
          DEFAULT: "var(--primary)",
          ...
          bg:      "var(--primary-bg)",
          // Flowbite docs use numeric scale — defined here since flowbite/plugin does NOT provide it
          50:  "var(--primary-bg)",
          ...
          800: "var(--primary-focus-hover)",
          900: "var(--primary-focus-hover)",
        },
        secondary: {
