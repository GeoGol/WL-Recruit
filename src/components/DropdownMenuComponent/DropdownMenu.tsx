                ...
                <ul className="py-2">
                    {items.map((child) => (
                        <li key={child.id} role="menuitem">
                            <a
                                href={child.link ?? "#"}
                                className="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-700 transition-colors hover:bg-blue-50 hover:text-blue-700 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white"
                            >
                                {/*{child.icon && (*/}
